package com.ff.common.screenadapter;
...
public final class ScreenAdapter {
    ...
    public static void cancelMatch(@NonNull final Context context, int matchUnit) {
        if (sMatchInfo != null) {
            ...
            if (matchUnit == MATCH_UNIT_DP) {
                Log.e("adapter", "displayMetrics.density=" + displayMetrics.density + ",sMatchInfo.getAppDensity()=" + sMatchInfo.getAppDensity());
                if (displayMetrics.density != sMatchInfo.getAppDensity()) {
                    displayMetrics.density = sMatchInfo.getAppDensity();
                }
                Log.e("adapter", "displayMetrics.densityDpi=" + displayMetrics.densityDpi + ",sMatchInfo.getAppDensityDpi()=" + sMatchInfo.getAppDensityDpi());
                if (displayMetrics.densityDpi != sMatchInfo.getAppDensityDpi()) {
                    displayMetrics.densityDpi = (int) sMatchInfo.getAppDensityDpi();
                }
                Log.e("adapter", "displayMetrics.scaledDensity=" + displayMetrics.scaledDensity + ",sMatchInfo.getAppScaledDensity()=" + sMatchInfo.getAppScaledDensity());
    ...
    private static void matchByDP(@NonNull final Context context, final float designSize, int base) {
        ...
        Log.e("adapter", "sMatchInfo.getScreenWidth()=" + sMatchInfo.getScreenWidth() + ",designSize=" + designSize);
        ...
        final DisplayMetrics displayMetrics = context.getResources().getDisplayMetrics();
        Log.e("adapter", "targetDensity=" + targetDensity + ",densityDpi=" + targetDensityDpi+",targetScaledDensity="+targetScaledDensity);
