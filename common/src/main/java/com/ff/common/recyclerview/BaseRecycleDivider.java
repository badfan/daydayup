...
public class BaseRecycleDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public BaseRecycleDivider(Context context, int orientation) {
...
//        }
     ...
     */
    public BaseRecycleDivider(Context context, int orientation, int drawableId) {
     ...
     */
    public BaseRecycleDivider(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
    ...
    private void drawGrideview(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (i < other) {
                ...
                left = (layoutParams.leftMargin + mDividerHeight) * (i + 1);
                right = child.getMeasuredWidth() * (i + 1) + left + mDividerHeight * i;
                if (mDivider != null) {
                    mDivider.setBounds(left, top, right, bottom);
                    mDivider.draw(canvas);
                }
            ...
            if (i != spancount) {
                top = (layoutParams.topMargin + mDividerHeight) * (i / linearLayoutManager.getSpanCount() + 1);
                bottom = (child.getMeasuredHeight() + mDividerHeight) * (i / linearLayoutManager.getSpanCount() + 1) + mDividerHeight;
